...
### Практическая часть
1. Ветвь 1 (Пушистый и нужно выгуливать):

![img](pictures/17.png)

2. Ветвь 2 (Пушистый и без выгула):

![img](pictures/15.png)

3. Ветвь 3 (Не пушистый и без аквариума):

![img](pictures/16.png)

4. Ветвь 4 (Не пушистый и есть аквариум):
   
![img](pictures/18.png)

6. Срабатывание правила защиты от некорректного ввода:
